(function ($, undefined) {
    $(document).ready(function () {
        ...
        Timeline.prototype.showEvent = function (index) {
            ...
            this.container.animate({ "height":this.events[index].el.find('.timeline-content').outerHeight() }, 400);
        ...
        (function () {
            ...
            $(document).on('mousemove.nickys-draggable', function (e) {
                ...
                if (startedDragging) {
                    ...
                    if (left < 0) {
                        left = 0;
                    } else if (left + targetTimeline.draggableWidth > maxLeft) {
                        left = maxLeft - targetTimeline.draggableWidth;
                    }
